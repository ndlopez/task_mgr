...
function add_form(thisTitle="Add a new task",edit=false){
    ...
    "<label for='fstage'>Stage</label><br><input type='text' id='fstage' name='fstage'><br><br><label for='fweek'>Timeline</label><br><input type='text' id='fweek' name='fweek'><br><br><label for='fstat'>Status[%]</label><br><input type='range' min='0' max='100' value='50' step='10' id='fstat' name='fstat' list='progres'><span><output id='rngVal'></output></span><br>" + listy + "<br><label for='fhours'>Worked hours</label><br><input type='text' id='fhours' name='fhours'><br><br><label for='farrive'>Arrived</label><br><input type='text' id='farrive' name='farrive'><br><br>" + buttons + "</form></div></div>";
