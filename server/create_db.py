...
def init_db():
    ...
    tasky = [('1','SAB-インフレーター組み付け','modeling','06-18,06-19,06-20',20,38,'2023-11-01'),('2','CADデータ処理方法','資料作成','06-17,06-21',60,4,'2024-06-17'),('3','HeartCore Know-How','資料作成','2024-06-21',10,20,'2023-06-27')]
